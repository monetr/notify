...
The full options shape lives in the [API reference](/api).

## Hover behavior

Hovering over a toast (or the stack as a whole) pauses the auto-dismiss timer and expands the stack so background items become legible. Pointer-leave resumes the timer.
